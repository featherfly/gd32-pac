#[doc = "Reader of register CPCPOLY"]
pub type R = crate::R<u32, super::CPCPOLY>;
#[doc = "Writer for register CPCPOLY"]
pub type W = crate::W<u32, super::CPCPOLY>;
#[doc = "Register CPCPOLY `reset()`'s with value 0x07"]
impl crate::ResetValue for super::CPCPOLY {
    type Type = u32;
    #[inline(always)]
