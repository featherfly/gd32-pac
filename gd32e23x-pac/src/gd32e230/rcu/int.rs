...
#[doc = "Write proxy for field `IRC28MSTBIC`"]
pub struct IRC28MSTBIC_W<'a> {
    w: &'a mut W,
}
impl<'a> IRC28MSTBIC_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `IRC28MSTBIE`"]
pub type IRC28MSTBIE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `IRC28MSTBIE`"]
pub struct IRC28MSTBIE_W<'a> {
    w: &'a mut W,
}
impl<'a> IRC28MSTBIE_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `IRC28MSTBIF`"]
pub type IRC28MSTBIF_R = crate::R<bool, bool>;
...
impl R {
    ...
    pub fn irc28mstbie(&self) -> IRC28MSTBIE_R {
        IRC28MSTBIE_R::new(((self.bits >> 13) & 0x01) != 0)
    }
    ...
    pub fn irc28mstbif(&self) -> IRC28MSTBIF_R {
        IRC28MSTBIF_R::new(((self.bits >> 5) & 0x01) != 0)
    }
