...
#[doc = "Reader of field `SWIEV21`"]
pub type SWIEV21_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SWIEV21`"]
pub struct SWIEV21_W<'a> {
    w: &'a mut W,
}
impl<'a> SWIEV21_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn swiev21(&self) -> SWIEV21_R {
        SWIEV21_R::new(((self.bits >> 21) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Software Interrupt on line 0"]
